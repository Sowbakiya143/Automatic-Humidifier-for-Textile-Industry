...
int setHumidity = 65; 
// Default required humidity int manualSwitch = 0; 
// Manual ON/OFF bool humidifierState = false;
...
if (manualSwitch == 1) { 
  ...
  humidifierState = true; 
     ...
     if (humidity < setHumidity) {
       digitalWrite(RELAY_PIN, LOW); 
       // ON humidifierState = true; 
       } else { digitalWrite(RELAY_PIN, HIGH);
        // OFF humidifierState = false; 
        } 
        }

/* Update Status LED */
 if (humidifierState) Blynk.virtualWrite(V3, 255);
